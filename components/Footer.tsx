...
export function Footer() {
  return (
    <footer className="flex shrink-0 flex-wrap items-center justify-between gap-x-4 gap-y-1 border-t border-ink/10 px-6 py-2.5 text-[0.7rem] text-ink-soft sm:px-10">
      <ThemeToggle />
